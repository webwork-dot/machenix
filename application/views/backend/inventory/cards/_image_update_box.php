...
<div class="dm-uploader-container">
  <div id="drag-and-drop-zone" class="dm-uploader text-center">
    ...
    <ul class="dm-uploaded-files" id="files-image">
      ...
      <li class="media">
        <img src="<?php echo get_product_image_url($modesy_image, 'image'); ?>" alt="">
        <a href="javascript:void(0)" class="btn-img-delete btn-delete-product-img"
          data-file-id="<?php echo $modesy_image->id; ?>">
          <i class="fa fa-times-circle"></i>
        </a>
        <?php if ($modesy_image->is_main == 1): ?>
        <!-- <a href="javascript:void(0)" class="badge badge-success badge-is-image-main btn-set-image-main">main</a> -->
        <?php else: ?>
        <!-- <a href="javascript:void(0)" class="badge badge-secondary badge-is-image-main btn-set-image-main"
          data-image-id="<?php echo $modesy_image->id; ?>"
          data-product-id="<?php echo $modesy_image->product_id; ?>">main</a> -->
        <?php endif; ?>
      </li>
      <?php endforeach;
            endif; ?>
