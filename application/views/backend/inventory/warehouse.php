  ...
  <div class="col-12">
    <div class="card">
      <div class="card-body">
        <div class="row">
          <div class="col-md-12 mt-10">
            <h5 class="mb-0"><b>Total Warehouse <span id="total_count"> (0)</span></b>
            </h5>
          </div>
        </div>
      </div>
      <div class="card-datatable d-report mb-2">
        ...
        <a href="<?php echo site_url('inventory/warehouse/add'); ?>"
          ...
          aria-controls="DataTables_Table_0"><span><i class="feather icon-plus"></i>
            <?= get_phrase('add_warehouse');?></span></a>
...
$(document).ready(function($) {
  var dataTable = $('#report-datatable').DataTable({
    ...
    "ajax": {
      "url": "<?php echo base_url('inventory/get_warehouse'); ?>",
      "dataType": "json",
      "type": "POST",
      "data": function(data) {
        var date_range = "";
