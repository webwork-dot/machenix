        ...
        <div class="row">
          <div class="col-12 col-sm-6 mb-1">
            <div class="form-group">
              ...
              <textarea class="form-control" name="remark" id="remark" rows="3" placeholder="Enter remark details (optional)"><?php echo htmlspecialchars($parent_product['remark'] ?? ''); ?></textarea>
            </div>
          </div>
        </div>
                ...
                <tbody id="charge_area">
                  ...
                  ?>
                    <tr class="charge-row" id="charge_row_<?php echo $c_index; ?>" data-id="<?php echo $c_index; ?>">
                      <td>
                        <select class="form-control select2 select-charge-expense" name="charge_expense_id[]" id="charge_expense_id_<?php echo $c_index; ?>" required style="width:100%">
                          <option value="">Select Expense Type</option>
                          <?php foreach($expenses as $exp) { ?>
                            <option value="<?php echo $exp['id']; ?>" <?php if($exp['id'] == $charge['expense_id']) echo 'selected'; ?>>
