         ...
         <div class="card-body">
            <div class="row">
               <div class="col-md-12 mt-10">
                  <h5 class="mb-0"><b>Total paidleave Data <span id="total_count"> (0)</span></b></h5>
               </div>
            </div>
         </div>
         <div class="card-datatable d-report mb-2"> 
		 <a href="<?php echo site_url('hr/paidleave/add'); ?>" class="dt-button add-new  add-btn btn btn-primary" tabindex="0" aria-controls="DataTables_Table_0" ><span><i data-feather='plus'></i> Add Paid Leave</span></a>  
            ...
            <table class="table leads-table tfixed" id="repots-datatable">
               <thead>
                  <tr>                                    
					...
					<th style="width:90px">Leaves</th>
					<th style="width:130px">Applied On Salary</th>
...
<script type="text/javascript"> 
  $(document).ready(function($) { 
        var dataTable = $('#repots-datatable').DataTable({ 
            ...
            "ajax":{
                "url": "<?php echo base_url('attendance/get_paidleave'); ?>",
                "dataType": "json",
                "type": "POST",
                "data": function(data){   
