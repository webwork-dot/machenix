  ...
  <div class="col-12">
    ...
    <div class="card" >
      <div class="card-body py-1 my-0">
          ...
          <?php echo form_open('inventory/damage_stock/add_post', ['class' => 'add-ajax-redirect-form','onsubmit' => 'return checkForm(this);']);?>  
          <div class="row">
            ...
            <div class="col-12 col-sm-3 mb-1">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Order No" name="reference_no" >
                </div>
            </div>
			<div class="col-12 col-sm-3 mb-1">
                <div class="form-group">
					  ...
					  <div class="row">
						 ...
						 <div class="col-12 col-sm-4 mb-1 mt-2">
							<div class="col-md-6 mt30" style="direction: rtl;">	
							   <label  for="bills_pending"></label><br>
							   <a class="btn btn-md btn-primary btn-file-upload downl-btn float-right" href="<?php echo base_url();?>phpspreadsheet/sample_product_damage_excel" target="_blank"><i class="fa fa-download" aria-hidden="true"></i> Download Format</a>
							   <!--<a class="btn btn-md btn-primary btn-file-upload downl-btn float-right" href="<?php echo base_url();?>uploads/x_return_stock_items.xlsx" target="_blank"><i class="fa fa-download" aria-hidden="true"></i> Download Format</a>-->
							</div>
						 </div>
					  </div>
					</div>
...
<script>
	...
	function check_available_qty(value,id) {
        ...
        for (let i = 1; i < total_element ; i++) {
            if($("#quantity_"+i).val()){
				...
				var available = parseInt($("#available_"+i).val());
	...
	function uploadExcel() {
		...
		if (!warehouseId) {
		 ...
		 $.ajax({
			type: "POST",
			url: "<?php echo base_url(); ?>phpspreadsheet/upload_damage_stock_items",
			data: formData,
			processData: false,
			contentType: false,
