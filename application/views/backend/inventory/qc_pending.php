...
<div class="row" id="table-bordered">
	...
	<div class="col-md-12 mb-1">
		<div class="fixedElement" id="fixedElement">
			<ul class="nav nav-pills bg-nav-pills nav-justified ">
                ...
                <li class="nav-item">
                    <a href="<?php echo base_url();?>inventory/qc-pending?warehouse=<?php echo $warehouse['id'];?>&type=pending" class="nav-link <?php echo ($warehouse_id == $warehouse['id']) ? 'active' : ''; ?>">
	...
	<div class="col-md-12 mb-1">
		<div class="fixedElement new-fix" id="fixedElement">
			<ul class="nav nav-pills bg-nav-pills nav-justified ">
				<li class="nav-item">
					<a href="<?php echo base_url();?>inventory/qc-pending?warehouse=<?php echo $warehouse_id;?>&type=pending" class="nav-link <?php echo ($type == 'pending') ? 'active' : ''; ?>">
						<i class="mdi mdi-home-variant d-md-none d-block"></i>
						<span class="d-none d-md-block">QC Pending</span>
					</a>
				</li>
				<li class="nav-item">
					<a href="<?php echo base_url();?>inventory/my-stock?warehouse=<?php echo $warehouse_id;?>&type=complete" class="nav-link <?php echo ($type == 'complete') ? 'active' : ''; ?>">
						<i class="mdi mdi-home-variant d-md-none d-block"></i>
						<span class="d-none d-md-block">My Stock</span>
					</a>
				</li>
			</ul>
		</div>
...
<script type="text/javascript">       
    $(document).ready(function($) {
    	...
    	"dom": '<"d-flex justify-content-between align-items-center mx-0 row"<"col-sm-12 col-md-6"l B><"col-sm-12 col-md-6"f>>t<"d-flex justify-content-between mx-0 row"<"col-sm-12 col-md-6"i><"col-sm-12 col-md-6"p>>',
            ...
            "ajax":{
                "url": "<?php echo base_url('inventory/get_qc_pending'); ?>",
                "dataType": "json",
                "type": "POST",
                "data": function(data){
