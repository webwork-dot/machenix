  ...
  <div class="col-12">
    ...
    <div class="card">
      <div class="card-body py-1 my-0">
          ...
          <?php echo form_open('admin/area/edit_post/'.$id, ['class' => 'add-ajax-form','onsubmit' => 'return checkForm(this);']);?>  
          <div class="row">
            ...
            <div class="col-12 col-sm-4 mb-1">
              ...
              <select class="select2 form-select" name="district_id"  id="states_">
                <option value="">Select District</option>
                <?php foreach($citys as $cit){?>
                <option value="<?php echo $cit['id'];?>" <?php if($cit['id'] == $data['district_id']){ echo 'selected'; } ?>><?php echo $cit['name'];?></option>
                <?php }?>
              </select>
            </div>
            
            <div class="col-12 col-sm-4 mb-1">
              <label class="form-label" for="city">Area</label>
              <input type="text" class="form-control" id="area" name="area" placeholder="Area" value="<?php echo $data['area'];?>" required>
            </div>
