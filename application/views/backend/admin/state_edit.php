  ...
  <div class="col-12">
    ...
    <div class="card">
      <div class="card-body py-1 my-0">
          <?php echo form_open('admin/state/edit_post/'.$id, ['class' => 'add-ajax-form','onsubmit' => 'return checkForm(this);']);?>   
          <div class="row">
            <div class="col-12 col-sm-4 mb-1">
              <label class="form-label" for="code">Code</label>
              <input type="text" class="form-control" id="code" name="code" placeholder="Code" value="<?php echo $data['code'];?>" required>
            </div>
