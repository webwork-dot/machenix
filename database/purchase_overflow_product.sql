...
--
-- Table structure for table `purchase_overflow_product`
--

CREATE TABLE `purchase_overflow_product` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `purchase_overflow_product`
--
ALTER TABLE `purchase_overflow_product`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `purchase_overflow_product`
--
ALTER TABLE `purchase_overflow_product`
