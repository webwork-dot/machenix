  ...
  <div class="col-12">
    ...
    <div class="card">
      <div class="card-body py-1 my-0">
          <?php echo form_open('inventory/warehouse/edit_post/'.$id, ['class' => 'add-ajax-redirect-form','onsubmit' => 'return checkForm(this);']);?>   
           ...
           <div class="row">
            ...
            <div class="col-12 col-sm-4 mb-1">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Warehouse Name" name="name" value="<?php echo $data['name']; ?>" required="">
                </div>
            </div>
            <div class="col-12 col-sm-4 mb-1">
                <div class="form-group">
