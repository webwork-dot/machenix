         ...
         <a class="w-100" href="#">
            <div class="card-st hiauto" style="">
               <div class="card-header d-flex">
                  <div>
                     <h2 class="text-bold-700 mb-0"><?php echo $stats['total_purchase_amt']; ?></h2>
                     <p>Total Purchase</p>
                  </div>
    ...
    <div class="col-md-4 col-sm-3 col-xs-12">
         <a class="w-100" href="#">
            <div class="card-st hiauto" style="">
               <div class="card-header d-flex">
                  <div>
                     <h2 class="text-bold-700 mb-0"><?php echo $stats['total_purchase_qty']; ?></h2>
                     <p>Total Quantity</p>
                  </div>
                  <div class="avatar bg-rgba-primary p-50 m-0">
    ...
    <div class="col-md-4 col-sm-3 col-xs-12">
         <a class="w-100" href="#">
            <div class="card-st hiauto" style="">
               <div class="card-header d-flex">
                  <div>
                     <h2 class="text-bold-700 mb-0"><?php echo $stats['total_purchase_avg']; ?></h2>
