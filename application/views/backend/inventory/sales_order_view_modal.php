...
<div class="sales-order-view-modal">
  <div class="row">
    <div class="col-12">
      ...
      <div class="row">
        <div class="col-md-6 mb-2">
          <div class="address-card shipping-card">
            ...
            <div class="address-text"><?php echo htmlspecialchars($sales_order['shipping_address']); ?></div>
            <div class="address-meta">
              <span><strong>City:</strong> <?php echo htmlspecialchars($sales_order['shipping_city_name'] ?? 'N/A'); ?></span>
              <span><strong>State:</strong> <?php echo htmlspecialchars($sales_order['shipping_state_name'] ?? 'N/A'); ?></span>
              <span><strong>Pincode:</strong> <?php echo htmlspecialchars($sales_order['shipping_pincode'] ?? 'N/A'); ?></span>
            </div>
          </div>
        </div>
        <div class="col-md-6 mb-2">
          <div class="address-card billing-card">
            ...
            <div class="address-text"><?php echo htmlspecialchars($sales_order['billing_address']); ?></div>
            <div class="address-meta">
              <span><strong>City:</strong> <?php echo htmlspecialchars($sales_order['billing_city_name'] ?? 'N/A'); ?></span>
              <span><strong>State:</strong> <?php echo htmlspecialchars($sales_order['billing_state_name'] ?? 'N/A'); ?></span>
              <span><strong>Pincode:</strong> <?php echo htmlspecialchars($sales_order['billing_pincode'] ?? 'N/A'); ?></span>
            </div>
          </div>
        </div>
      </div>
      ...
      <!-- Remark Section -->
      <?php if (!empty($sales_order['remark'])) { ?>
        <div class="notes-card">
          <div class="notes-title"><i class="fa fa-commenting-o"></i> Remark / Notes</div>
          <div class="notes-content"><?php echo nl2br(htmlspecialchars($sales_order['remark'])); ?></div>
        </div>
      <?php } ?>
