...
<div class="bg-white customer-card-shell mb-3">
  ...
  <div class="d-flex align-items-center justify-content-between px-2 py-2 card-soft-header">
    <div>
      <div class="text-uppercase fw-semibold fs-10 track-1 mb-1">Vendor</div>
      <div class="fw-semibold customer-main-text fs-15"><?= html_escape($vendor['name'] ?? '—') ?></div>
    </div>
  </div>
    ...
    <div class="flex-fill px-2 py-2 customer-info-col">
      ...
      <table class="w-100 key-info-table fs-12">
        <tr>
          ...
          <td class="customer-main-text fw-semibold"><?= html_escape($vendor['contact_name'] ?? '—') ?></td>
        </tr>
        <tr>
        ...
        <?php if (!empty($vendor['gst_no'])): ?>
          <tr>
            ...
            <td class="customer-main-text fw-semibold"><?= html_escape($vendor['gst_no']) ?></td>
          </tr>
        <?php endif; ?>
        <?php if (!empty($vendor['email'])): ?>
          <tr>
            <td class="text-secondary fw-medium">Email</td>
            <td class="customer-main-text fw-semibold"><?= html_escape($vendor['email']) ?></td>
          </tr>
        <?php endif; ?>
      </table>
    </div>
...
foreach ($ledger as $item) {
  $tKey = $item['is_payment'] ? 'payment' : 'expenses';
...
<div>
  <div class="bg-white ledger-card-shell">
    <!-- Ledger Header -->
    <div class="d-flex align-items-center justify-content-between px-2 py-2 card-soft-header">
      <div class="fw-semibold customer-main-text fs-13">Vendor Ledger</div>
