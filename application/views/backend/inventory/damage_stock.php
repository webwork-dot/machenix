   ...
   <div class="col-12">
      <div class="card">
        ...
        <div class="card-datatable d-report mb-2">
		   ...
		   <a href="<?php echo site_url('inventory/damage-stock/add'); ?>" class="dt-button add-new desktop-tab  add-btn btn btn-primary" tabindex="0" aria-controls="DataTables_Table_0" ><span><i class="feather icon-plus"></i> <?= get_phrase('add_damage_stock');?></span></a>         
...
<script type="text/javascript">       
    $(document).ready(function($) {
    	...
    	"dom": '<"d-flex justify-content-between align-items-center mx-0 row"<"col-sm-12 col-md-6"l B><"col-sm-12 col-md-6"f>>t<"d-flex justify-content-between mx-0 row"<"col-sm-12 col-md-6"i><"col-sm-12 col-md-6"p>>',
            ...
            "ajax":{
                "url": "<?php echo base_url('inventory/get_damage_stock'); ?>",
                "dataType": "json",
                "type": "POST",
                "data": function(data){
