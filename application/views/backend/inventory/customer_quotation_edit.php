  ...
  <div class="col-12">
    <div class="card">
      <div class="card-body py-1 my-0">
        ...
        <?php echo form_open('inventory/customer-quotations/edit_post/' . $data['id'], ['class' => 'add-ajax-redirect-form','onsubmit' => 'return checkForm(this);']);?>
        <div class="row">
          <div class="col-12 col-sm-3 mb-1">
            <div class="form-group">
              <label>Quotation No <span class="required">*</span></label>
              <input type="text" class="form-control" placeholder="Quotation No" name="order_no"
          ...
          <input type="hidden" name="warehouse_id" value="<?php echo $data['warehouse_id'] ?? 0; ?>">
          <input type="hidden" name="company_id" value="<?php echo $data['company_id'] ?? $this->session->userdata('company_id'); ?>">
          <input type="hidden" name="narration" value="<?php echo $data['narration'];?>">

          <div class="col-12 col-sm-12 mb-1">
            <div class="form-group">
              <label>Remark</label>
              <textarea class="form-control" placeholder="Enter Remark" rows="2" name="remark" id="remark"><?php echo $data['remark'];?></textarea>
            </div>
          </div>
              ...
              <table class="table table-bordered table-sm compact-table">
                ...
                <tbody id="requirement_area">
                  ...
                  <tr class="element-1 sales-line-item" id="product_<?php echo $k; ?>" data-id="<?php echo $k; ?>">
                    <td>
                      ...
                      <select class="form-control select2 product_id" name="product_id[]" id="product_id_<?php echo $k; ?>" data-toggle="select2" onchange="get_details_by_product(this.value,'<?php echo $k; ?>');" required>
                        ...
                        <?php if (!empty($products_list)) { foreach($products_list as $pl) { ?>
                    ...
                    <td>
                      <div class="input-group">
                        <input type="number" step="any" id="master_amount_<?php echo $k; ?>" name="master_amount[]" onkeyup="calculate_amt('<?php echo $k; ?>')" value="<?php echo $product['amount']; ?>" class="form-control" required="">
                    ...
                    <td><input type="number" step="any" id="black_amount_<?php echo $k; ?>" name="black_total[]" value="<?php echo ($product['total_amount'] - $product['bill_total']); ?>" class="form-control" tabindex="-1" readonly></td>
                    <td>
                      ...
                      <input type="hidden" id="available_<?php echo $k; ?>" name="available[]" value="0">
                    </td>
                    <td class="text-center align-middle" style="white-space:nowrap;">
                      ...
                      <button type="button" class="btn btn-danger btn-sm waves-effect waves-float waves-light btn-remove-line" onclick="removeRequirement(this,<?php echo $k; ?>)"> <i class="fa fa-times" aria-hidden="true"></i> </button>
                    </td>
                  </tr>
                  <?php $k++; } } else { ?>
                  <tr class="element-1 sales-line-item" id="product_1" data-id="1">
                    ...
                    <td>
                      <div class="input-group">
                        <input type="number" step="any" id="master_amount_1" name="master_amount[]" onkeyup="calculate_amt('1')" value="" class="form-control" required="">
              ...
              <table class="table table-bordered table-sm compact-table">
                ...
                <tbody id="charges_area">
                  <tr class="element-charge-1 charge-line-item" id="charge_1" data-id="1">
                    ...
                    <td><input type="number" step="any" id="charge_price_1" name="charge_price[]" placeholder="Amount" class="form-control charge-input" onkeyup="calculate_charge('1')" value="<?php echo $data['other_charges_amount'] ?? 0; ?>"></td>
                    <td><input type="number" step="any" id="charge_total_1" name="charge_total[]" placeholder="Total Amount" class="form-control" tabindex="-1" readonly value="<?php echo $data['other_charges_amount'] ?? 0; ?>"></td>
                    <td class="text-center align-middle" style="white-space:nowrap;">
                    ...
                    <tr>
                      ...
                      <td colspan="1">
                        <p class="td-blank"><input type="number" step="any" name="basic_value" id="basic_value"
                            value="<?php echo $data['basic_value']; ?>" placeholder="Total Bill Amt (Exc GST)" class="form-control" readonly></p>
                      </td>
                    </tr>
                      ...
                      <td colspan="4" class="text-right align-middle">
                        <div class="d-flex flex-column align-items-end">
                          ...
                          <select class="form-control " name="gst_type" id="gst_type" onchange="change_gst(this.value); recalculate();" style="width : 200px !important;float:right !important">
                            <option value="Central GST / State GST" <?php if($data['gst_type'] == 'Central GST / State GST') echo 'selected';?>>Central GST / State GST</option>
                            <option value="IGST" <?php if($data['gst_type'] == 'IGST') echo 'selected';?>>IGST</option>
                          </select>
                        </div>
                      </td>
                      <td colspan="1">
                        <div id="cgst_sgst_inputs" class="<?php if($data['gst_type'] == 'IGST') echo 'hidden';?>">
                          <p class="td-blank mb-25">
                            <input type="number" step="any" name="central_gst" id="central_gst" value="<?php echo $data['central_gst']; ?>" placeholder="CGST Amount" class="form-control" readonly>
                          </p>
                          <p class="td-blank mb-0">
                            <input type="number" step="any" name="state_gst" id="state_gst" value="<?php echo $data['state_gst']; ?>" placeholder="SGST Amount" class="form-control" readonly>
                          </p>
                        </div>
                        <div id="igst_input" class="<?php if($data['gst_type'] != 'IGST') echo 'hidden';?>">
                          <p class="td-blank mb-0">
                            <input type="number" step="any" name="igst" id="igst" value="<?php echo $data['igst']; ?>" placeholder="IGST Amount" class="form-control" readonly>
                          </p>
                        </div>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td colspan="1">
                        <p class="td-blank"><input type="number" step="any" name="net_sales_value_1"
                            id="net_sales_value_1" value="<?php echo $data['net_sales_value_1']; ?>" placeholder="Total Bill Amt (Incl GST)"
                    ...
                    <tr>
                      ...
                      <td colspan="1">
                        <p class="td-blank"><input type="number" step="any" name="total_black_amount_summary"
                            id="total_black_amount_summary" value="<?php echo $data['total_black_amt']; ?>" placeholder="Total Black Amt"
                            class="form-control" readonly></p>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td colspan="1">
                        <p class="td-blank"><input type="number" step="any" name="net_sales_value_2"
                            id="net_sales_value_2" value="<?php echo $data['net_sales_value_2']; ?>" placeholder="Final Total"
                            class="form-control" readonly></p>
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td colspan="1">
                        <p class="td-blank"><input type="number" step="any" name="other_charges_amount"
                            id="other_charges_amount" placeholder="Charge Amount" class="form-control" value="<?php echo $data['other_charges_amount']; ?>" readonly></p>
                      </td>
                    </tr>
                    <tr>
                      <td colspan="4" class="text-right">
  ...
  if (customer_id == '') {
    ...
    $('#requirement_area').append(`
      <tr class="element-1 sales-line-item" id="product_${nextindex}" data-id="${nextindex}">
        ...
        <td>
          <div class="input-group">
            <input type="number" step="any" id="master_amount_${nextindex}" name="master_amount[]" class="form-control" onkeyup="calculate_amt('${nextindex}')" required>
  ...
  $.ajax({
    ...
    success: function(res) {
        if(res.status == 200) {
            ...
            $('#bill_amount_' + index).val(res.rate);
            calculate_amt(index);
        } else {
            alert(res.message);
        }
