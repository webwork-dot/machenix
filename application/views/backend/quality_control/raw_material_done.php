...
<div class="row" id="table-bordered">
	...
	<div class="col-md-12 mb-1">
		<div class="fixedElement new-fix" id="fixedElement">
			<ul class="nav nav-pills bg-nav-pills nav-justified ">
				<li class="nav-item">
					<a href="<?php echo base_url();?>quality-control/raw-material?warehouse=<?php echo $warehouse_id;?>" class="nav-link ">
						<i class="mdi mdi-home-variant d-md-none d-block"></i>
						<span class="d-none d-md-block">Pending</span>
					</a>
				</li>
				<li class="nav-item">
					<a href="<?php echo base_url();?>quality-control/raw-material-done?warehouse=<?php echo $warehouse_id;?>" class="nav-link active">
						<i class="mdi mdi-home-variant d-md-none d-block"></i>
