              ...
              <table class="table table-bordered table-sm compact-table">
                <thead class="table-light text-center">
                  <tr>
                    ...
                    <th style="min-width:120px;" class="col-hide">Per Qty Bill <span class="text-danger">*</span></th>
                    <th style="min-width:100px;" class="col-hide">Total Bill</th>
                    ...
                    <th style="min-width:110px;" class="col-hide">Per Qty Black</th>
                    <th style="min-width:100px;" class="col-hide">Total Black</th>
                    <th style="min-width:120px;" class="col-hide">Final Total</th>
                ...
                <tbody id="requirement_area">
                  <tr class="element-1 sales-line-item" id="product_1" data-id="1">
                    ...
                    <td class="col-hide"><input type="hidden" id="black_amount_1" name="black_total[]" value="0"></td>
                    <td class="col-hide">
  ...
  if (customer_id == '') {
    ...
    $('#requirement_area').append(`
      <tr class="element-1 sales-line-item" id="product_${nextindex}" data-id="${nextindex}">
        ...
        <td class="col-hide"><input type="hidden" id="black_amount_${nextindex}" name="black_total[]" value="0"></td>
        <td class="col-hide">
        ...
        <td>
          <div class="d-flex align-items-center">
            <div class="d-flex flex-column align-items-center" style="flex: 1;">
              <span class="badge mb-25" style="font-size: 9px; padding: 2px 4px; background-color: #28c76f !important; color: #ffffff !important; font-weight: bold; display: inline-block;">Avail. White: <span class="avail-white-text">0</span></span>
            ...
            <div class="d-none">
              <input type="number" class="batch_black_qty_input" name="batch_black_qty[${index}][]" id="batch_black_qty_${index}_${batch_index}" value="0">
