  ...
  <div class="col-12">
    ...
    <div class="card">
      <div class="card-body py-1 my-0">
            ...
            <?php $unique_id = $data['unique_id'];?>
          <div class="row">
            
			
			<div class="col-12">
				<div id = "requirement_area"> 
					<?php $order_product = $this->common_model->selectByids(array("unique_id"=> $unique_id,"is_move"=> 0),'excel_orders','id','ASC');
					$i= '1';
							...
							<div class="row">
                                ...
                                <div class="col-md-2">
									<div class="form-group">
										...
										<input type="text" class="form-control" value="<?php echo $op->order_no;?>" readonly>
									</div>
								</div>
								<div class="col-md-2">
									<div class="form-group">
								...
								<div class="col-md-3">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" value="<?php echo $op->product_name . ' | ' . $op->size;?>" readonly>
									</div>
								</div>
								<div class="col-md-2">
									<div class="form-group">
										<label>Total Amount <span class="required">*</span></label>
										<input type="text" class="form-control" value="<?php echo $op->amount;?>" readonly>
									</div>
								</div>
								<div class="col-md-1 pl-0">
									<div class="form-group">
										<label>Qty <span class="required">*</span></label>
										<input type="text" class="form-control" value="<?php echo $op->quantity;?>" readonly>
									</div>
								</div>
					...
					<?php $i++; }}else{ ?>
					<div class="col-md-12">
						<h4 class="text-center"> All Product Are Uploaded !!!!</h4>
					</div>
					<?php } ?>
