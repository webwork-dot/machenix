  ...
  <div class="col-12">
    ...
    <div class="card">
      <div class="card-body py-1 my-0">
        ...
        <?php echo form_open('inventory/payment_reconceliation/add_post', ['class' => 'add-ajax-redirect-form', 'onsubmit' => 'return checkForm(this);']); ?>
        <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-12 col-sm-4 mb-1 mt-2">
                    <div class="col-md-6 mt30" style="direction: rtl;">
                      <label for="bills_pending"></label><br>
                      <a class="btn btn-md btn-primary btn-file-upload downl-btn float-right" href="<?php echo base_url(); ?>phpspreadsheet/sample_product_payment_excel" target="_blank"><i class="fa fa-download" aria-hidden="true"></i> Download Format</a>
...
<script>
        ...
        $('#requirement_area').append(`<tbody class="element-1 new-table" id="product_${nextindex}">
                                                  <tr>
                                                    ...
                                                    <td>
                                                     ...
                                                     <td>
                                                        <p class="td-blank">
                                                          <input type="number" step="any" id="amount_${nextindex}"  name="amount[]" placeholder="Amount"  value="0" class="form-control">
                                                        </p>
                                                      </td>
                                                    <td>
  ...
  function uploadExcel() {
    ...
    $.ajax({
      type: "POST",
      url: "<?php echo base_url(); ?>phpspreadsheet/upload_sales_payment_stock_items",
      data: formData,
      processData: false,
      contentType: false,
      success: function(data) {
        ...
        if (data.status == '200') {
    		...
    		document.querySelector('.manually_div').remove();
    		$(".loader").fadeOut("slow");
