...
<div class="row" id="table-bordered">
   <div class="col-12">
      <div class="card">
         ...
         <?php include '_filter_hold_salary.php';?>
         
         <div class="card-body">
            <div class="row">
               <div class="col-md-12 mt-10">
                  <h5 class="mb-0"><b>Total Hold Salary <span id="total_count"> (0)</span></b></h5>
               </div>
            </div>
         </div>
...
<script type="text/javascript">
    $(document).ready(function($) { 
        var dataTable = $('#flash-datatable').DataTable({ 
            ...
            "ajax":{
                "url": "<?php echo base_url('attendance/get_hold_salary_report'); ?>",
                "dataType": "json",
                "type": "POST",
                "data": function(data){
