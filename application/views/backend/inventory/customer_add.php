  ...
  <div class="col-12">
    <div class="card">
      <div class="card-body py-1 my-0">
        ...
        <?php echo form_open('inventory/customer/add_post', [
          ...
          <div class="row">
            ...
            <div class="col-12 col-sm-6 mb-1">
              <div class="form-group">
                ...
                <textarea class="form-control" placeholder="Enter Address Line 1" name="address" rows="2" required></textarea>
              </div>
            </div>
            ...
            <div class="col-12 col-sm-6 mb-1">
              <div class="form-group">
                ...
                <textarea class="form-control" placeholder="Enter Address Line 2" name="address_2" rows="2"></textarea>
              </div>
            </div>
            ...
            <div class="col-12 col-sm-3 mb-1">
              <div class="form-group">
                ...
                <input
                  type="text"
                  class="form-control"
                  placeholder="Enter Other Whatsapp"
                  name="other_whatsapp"
                  inputmode="numeric"
                  maxlength="10"
                  minlength="10"
  ...
  function get_city_(stateId) {
    $.ajax({
      ...
      success: function (html) {
        ...
        $("#city_id").append(html);
        // If select2 is used and you want it to refresh:
