...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 10, 2026 at 03:52 PM
...
--
-- Table structure for table `formula_ingredients_batch_products`
--
...
--
-- Indexes for table `formula_ingredients_batch_products`
--
ALTER TABLE `formula_ingredients_batch_products`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `formula_ingredients_batch_products`
--
ALTER TABLE `formula_ingredients_batch_products`
