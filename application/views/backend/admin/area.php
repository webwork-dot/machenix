    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="col-sm-12 col-md-3">
                  <a style="float:right;" href="<?php echo site_url('admin/area/add'); ?>" class="dt-button add-new btn btn-primary" tabindex="0" aria-controls="DataTables_Table_0" ><span><i data-feather='plus'></i> Add Area</span></a>
         </div>
        </div>
      </div>
        ...
        <table class="table table-bordered">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                  <a href="<?php echo site_url('admin/area/edit/'.$item['id']); ?>" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit"><button type="button" class="btn mr-1 mb-1 icon-btn-edit"><i data-feather="edit-2"></i></button> </a> 
              </td>
            </tr>
            <?php endforeach; ?>
          </tbody>
          ...
          <?php if (empty($orders)): ?>
                <p class="notf" class="">Area Data Not Found</p>
            <?php endif; ?>
