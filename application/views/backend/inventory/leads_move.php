  ...
  <div class="col-12">
    <div class="card">
      <div class="card-body py-1 my-0">
        ...
        <?php echo form_open('inventory/customer/move_post/'.$id, [
          ...
          <div class="row">
            ...
            <div class="col-12 col-sm-3 mb-1">
              <div class="form-group">
                ...
                <select class="form-select select2" name="company_id[]" id="company_id" onchange="get_staff();" multiple required>
                  <?php
        ...
        <fieldset class="form-fieldset">
          ...
          <div class="row">
            ...
            <div class="col-12 col-sm-3 mb-1">
              <div class="form-group">
                <label>
                  Owner Whatsapp Number <span class="required">*</span>
                </label>
