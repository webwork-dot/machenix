         ...
         <div class="card-body">
            <div class="row">
               <div class="col-md-12 mt-10">
                  <h5 class="mb-0"><b>Total Candidate <span id="total_count"> (0)</span></b></h5>
               </div>
            </div>
         </div>
            ...
            <table class="table leads-table tfixed" id="flash-datatable">
               <thead>
                  <tr>
                    ...
                    <th style="width:110px">Approved Date</th>
...
<script type="text/javascript">
    $(document).ready(function($) { 
        var dataTable = $('#flash-datatable').DataTable({ 
            ...
            "ajax":{
                "url": "<?php echo base_url('hr/get_assign_salary'); ?>",
                "dataType": "json",
                "type": "POST",
                "data": function(data){
                    ...
                    data.staff_type = "<?php if(isset($_GET['staff_type'])) { echo $_GET['staff_type']; }?>";			
                }
            },   
