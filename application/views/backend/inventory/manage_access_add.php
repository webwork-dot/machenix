   ...
   <div class="col-xl-12">
      <div class="card">
         <div class="card-body">
            ...
            <form class="required-form add-ajax-form" action="<?php echo site_url('inventory/manage_access/add_post'); ?>" onsubmit="return checkForm(this);"  enctype="multipart/form-data" method="post">      
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 my-1">
                        <div class="form-group">
                            <?php foreach($access_type as $item):?>
                                <div class="form-check mb-1 access-div">
                                    <input type="checkbox" class="form-check-input" name="access_id[]" value="<?php echo $item['id'];?>" id="<?php echo $item['id'];?>">
