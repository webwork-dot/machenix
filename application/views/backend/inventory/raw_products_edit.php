        ...
        <div class="row">
          ...
          <div class="col-12 col-sm-3 mb-1">
            <div class="form-group">
              ...
              <input type="number" class="form-control" placeholder="Enter Duty Charge" name="duty_charge" min="0" max="100" step="any"
                value="<?php echo isset($data['duty_charge']) ? formatNumber($data['duty_charge']) : '0'; ?>">
            </div>
          </div>
            ...
            <div class="form-group">
              ...
              <select class="form-select select2" name="commission_id" required>
                ...
                <?php foreach ($commissions as $comm): ?>
                  <option value="<?php echo $comm['id']; ?>" <?php echo (isset($data['commission_id']) && $data['commission_id'] == $comm['id']) ? 'selected' : ''; ?>><?php echo $comm['name']; ?> (<?php echo $comm['commission']; ?>%)</option>
                <?php endforeach; ?>
              </select>
            </div>
          </div>
          ...
          <div class="col-12 col-sm-3 mb-1">
            <div class="form-group">
              ...
              <input type="number" class="form-control" placeholder="Enter Official Sale Amt" name="off_sale_price" min="0" step="0.00001"
                value="<?php echo isset($data['off_sale_price']) ? htmlspecialchars($data['off_sale_price']) : '0.00000'; ?>">
            </div>
          </div>
                  ...
                  <div class="row variation-row" data-row-index="<?php echo $index; ?>">
                    ...
                    <div class="col-12 col-sm-3 mb-1">
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control" placeholder="Enter Net Weight"
                          name="variation_net_weight[]" value="<?php echo formatNumber($variation['net_weight']); ?>"
                          step="0.00001">
                      </div>
                    </div>
                    ...
                    <div class="col-12 col-sm-3 mb-1">
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control" placeholder="Enter Gross Weight"
                          name="variation_gross_weight[]" value="<?php echo formatNumber($variation['gross_weight']); ?>"
                          step="0.00001">
                      </div>
                    </div>
                    ...
                    <div class="col-12 col-sm-3 mb-1">
                      <div class="form-group">
                        <label>Length</label>
                        <input type="number" class="form-control" placeholder="Enter Length" name="variation_length[]"
                          value="<?php echo formatNumber($variation['length']); ?>" step="0.00001">
                      </div>
                    </div>
                    ...
                    <div class="col-12 col-sm-3 mb-1">
                      <div class="form-group">
                        <label>Width</label>
                        <input type="number" class="form-control" placeholder="Enter Width" name="variation_width[]"
                          value="<?php echo formatNumber($variation['width']); ?>" step="0.00001">
                      </div>
                    </div>
                    ...
                    <div class="col-12 col-sm-3 mb-1">
                      <div class="form-group">
                        <label>Height</label>
                        <input type="number" class="form-control" placeholder="Enter Height" name="variation_height[]"
                          value="<?php echo formatNumber($variation['height']); ?>" step="0.00001">
                      </div>
                    </div>
                    ...
                    <div class="col-12 col-sm-3 mb-1">
                      <div class="form-group">
                        ...
                        <input type="number" class="form-control" placeholder="Enter CBM" name="variation_cbm[]" required
                          value="<?php echo formatNumber($variation['cbm']); ?>" step="0.00001">
                      </div>
                    </div>
                    ...
                    <?php if ($index > 0): ?>
                      <div class="col-12 col-sm-3 mb-1 d-flex align-items-end">
                        <button type="button" class="btn btn-danger waves-effect waves-float waves-light"
                          onclick="removeVariationRow(this, '<?php echo $variation['id']; ?>')">
                ...
                <div class="row variation-row" data-row-index="0">
                  ...
                  <div class="col-12 col-sm-3 mb-1">
                    <div class="form-group">
                      <label>Net Weight</label>
                      <input type="number" class="form-control" placeholder="Enter Net Weight"
                        name="variation_net_weight[]" value="<?php echo formatNumber($data['net_weight']); ?>"
                        step="0.00001">
                    </div>
                  </div>
                  ...
                  <div class="col-12 col-sm-3 mb-1">
                    <div class="form-group">
                      <label>Gross Weight</label>
                      <input type="number" class="form-control" placeholder="Enter Gross Weight"
                        name="variation_gross_weight[]" value="<?php echo formatNumber($data['gross_weight']); ?>"
                        step="0.00001">
                    </div>
                  </div>
                  ...
                  <div class="col-12 col-sm-3 mb-1">
                    <div class="form-group">
                      <label>Length</label>
                      <input type="number" class="form-control" placeholder="Enter Length" name="variation_length[]"
                        value="<?php echo formatNumber($data['length']); ?>" step="0.00001">
                    </div>
                  </div>
                  ...
                  <div class="col-12 col-sm-3 mb-1">
                    <div class="form-group">
                      <label>Width</label>
                      <input type="number" class="form-control" placeholder="Enter Width" name="variation_width[]"
                        value="<?php echo formatNumber($data['width']); ?>" step="0.00001">
                    </div>
                  </div>
                  ...
                  <div class="col-12 col-sm-3 mb-1">
                    <div class="form-group">
                      <label>Height</label>
                      <input type="number" class="form-control" placeholder="Enter Height" name="variation_height[]"
                        value="<?php echo formatNumber($data['height']); ?>" step="0.00001">
                    </div>
                  </div>
                  ...
                  <div class="col-12 col-sm-3 mb-1">
                    <div class="form-group">
                      <label>CBM <span class="required">*</span></label>
                      <input type="number" class="form-control" placeholder="Enter CBM" name="variation_cbm[]" required
                        value="<?php echo formatNumber($data['cbm']); ?>" step="0.00001">
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="col-12 variation-add-btn-container">
            <button type="button" class="btn-add-product waves-effect waves-float waves-light"
