   ...
   <div class="col-12">
      <div class="card">
	      ...
	      <div class="top-header">
             <div class="row ">   
                <div class="col-md-6"> 
                   <a class="nav-link " href="<?php echo base_url();?>hr/documentation" >Pending <b>(<?php echo $pending_count;?>)</b></a>
                </div>
                <div class="col-md-6"> 
                   <a class="nav-link active" href="<?php echo base_url(); ?>hr/verified-documentation">Not Verified <b>(<?php echo $verified_count;?>)</b></a>
                </div>             
             </div>
         </div>
