...
<div class="row">
  <div class="col-12">
    <!-- Compact Edit Customer Adjustment Form Card -->
    <div class="card mb-2">
          ...
          <div class="row g-2">
            ...
            <div class="col-md-12 mb-2" id="inr_col">
              ...
              <div class="input-group">
                ...
                <input type="number" step="0.01" name="inr" id="inr" class="form-control amount-field" placeholder="0.00" value="<?= html_escape($row['inr'] ?? '0.00') ?>" required>
              </div>
            </div>
          </div>
