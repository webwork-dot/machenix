          ...
          <div class="row">
            <div class="col-12 col-sm-3 mb-1">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Order No" name="order_no" value="<?php echo $order_no;?>" required="" readonly>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-3 mb-1">
              ...
              <select class=" form-select select2" name="warehouse_id" id="warehouse_id" onchange="get_product_by_warehouse(this.value,'1');"  required>
							...
							<div class="row">
                                ...
                                <div class="col-md-1 pl-0">
									<div class="form-group">
										...
										<input type="text" step="any" id="porder_id_1" name="porder_id[]" class="form-control" required>
									</div>
								</div>
								...
								<div class="col-md-2 pl-0">
									<div class="form-group">
										...
										<input type="text" step="any" id="customer_name_1" name="customer_name[]" class="form-control" required>
									</div>
								</div>
								...
								<div class="col-md-2 pl-0">
									<div class="form-group">
										...
										<input type="number" step="any" id="pincode_1" name="pincode[]" class="form-control" required>
									</div>
								</div>
								...
								<div class="col-md-2 pl-0">
									...
									<div class="form-group">
										<label>Select SKU - Size<span class="required">*</span></label>
										 <select class="form-control select2 product_id"  name="product_id[]"  id="product_id_1" data-toggle="select2" onchange="get_batch_by_product(this.value,'1_1');"  required>
								...
								<div class="col-md-1 pl-0">
									<div class="form-group">
										...
										<input type="number" step="any" id="total_amount_1" name="total_amount[]" onkeyup="recalculate()"   value="" class="form-control" >
									</div>
								</div>
								...
								<div class="col-md-1 pl-0">
									<div class="form-group">
										...
										<input type="number" step="any" id="quantity_1_1" name="quantity[]" placeholder="Qty" onkeyup="check_available_qty(this.value,'1')" value="1" class="form-control quantity_1" required="">
									</div>
								</div>
								...
								<div class="col-md-1 pl-0">
									<div class="form-group">
										<label>&nbsp;</label><br/>
										<button type="button" class="btn btn-danger btn-sm waves-effect waves-float waves-light" style="" name="button" onclick="removeRequirement(this,1)"> <i class="fa fa-times" aria-hidden="true"></i> </button>  
									</div>
								</div>
			...
			<center>  			   
				<div class="col-md-12  pl-0 m-auto">
					<button type="button" class="btn btn-outline-primary waves-effect" onclick="appendRequirement()"> <i class="fa fa-plus" aria-hidden="true"></i> Add New Product</button>
				</div>
            </center> 
                        ...
                        <table class="table table-striped table-bordered mn-table mt-1">
                                    <tbody>
                                        <tr>
                                          ...
                                          <td colspan="1">
                                            <p class="td-blank"><input type="number" step="any"  name="basic_value" id="basic_value" value="0" placeholder="Basic Value" class="form-control" readonly></p>
										...
										<tr>
										  ...
										  <td colspan="1">
											<p class="td-blank"><input type="number" step="any"  name="net_sales_value_1" id="net_sales_value_1" value="0" placeholder="Basic Net Sales Value (Excl. GST)" class="form-control" readonly></p>
										  </td>
										</tr>
										...
										<tr class="hidden" id="cgst_gst">
										  <th colspan="4" class="text-right align-middle">
											 ...
											 <input type="text"  oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" name="cgst_per" id="cgst_per"  onkeyup="recalculate()" placeholder="in(%)" value="0" class="form-control dis-input" >
										  </th>
										  <th colspan="1">
											 <p class="td-blank"><b><input type="number" step="any"  name="central_gst" id="central_gst"   value="0"  placeholder="Add : IN: Central GST" class="form-control" readonly></b></p>
										  </th>
										</tr>
										...
										<tr class="hidden" id="sgst_gst">
										  <th colspan="4" class="text-right align-middle">
											 ...
											 <input type="text"  oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" name="sgst_per" id="sgst_per"  onkeyup="recalculate()" placeholder="in(%)" value="0" class="form-control dis-input" readonly>
										  </th>
										  <th colspan="1">
											 <p class="td-blank"><b><input type="number" step="any"  name="state_gst" id="state_gst"   value="0"  placeholder="Add : IN: State GST" class="form-control" readonly></b></p>
										  </th>
										</tr>
										...
										<tr class="hidden" id="igst_gst">
										  <th colspan="4" class="text-right align-middle">
											 ...
											 <input type="text"  oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" name="igst_per" id="igst_per"  onkeyup="recalculate()" placeholder="in(%)" value="0" class="form-control dis-input" >
										  </th>
										  <th colspan="1">
											 <p class="td-blank"><b><input type="number" step="any"  name="igst" id="igst"  value="0"  placeholder="Add : IN: IGST" class="form-control" readonly></b></p>
										  </th>
										</tr> 
                                        ...
                                        <tr>
                                          ...
                                          <td colspan="1">
                                            <p class="td-blank"><input type="number" step="any"  name="net_sales_value_2" id="net_sales_value_2" value="0" placeholder="Basic Net Sales Value (Inc. GST)" class="form-control" readonly></p>
										...
										<tr>
                                          <td colspan="4" class="text-right">
											 ...
											 <input type="text" step="any" name="other_charges_name" id="other_charges_name" value="" placeholder="Charge Name" class="form-control dis-input-1">
                                          </td>
                                          <td colspan="1">
                                             <p class="td-blank"><input type="number" step="any"  name="other_charges_amount" id="other_charges_amount" placeholder="Charge Amount" class="form-control" value="0" onkeyup="recalculate()" ></p>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td colspan="4" class="text-right">
