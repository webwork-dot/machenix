  ...
  <div class="col-12">
    ...
    <div class="card">
      <div class="card-body py-1 my-0">
          ...
          <?php echo form_open('attendance/loans/edit_post/'.$id, ['class' => 'add-ajax-redirect-image-form', 'enctype' => 'multipart/form-data', 'onsubmit' => 'return checkForm(this);' ]);?>
          <div class="row">
		   ...
		   <div class="col-12 col-sm-4 mb-2">
              <div class="form-group">
                 ...
                 <select class="form-select" name="loan_type" required>
                    <option value="" <?php if($data['loan_type'] == ''){ echo 'selected';}?>>Select</option>
                    <option value="mobile_loan" <?php if($data['loan_type'] == 'mobile_loan'){ echo 'selected';}?>>Mobile Loan</option>
                    <option value="cash_loan" <?php if($data['loan_type'] == 'cash_loan'){ echo 'selected';}?>>Cash Loan</option>
                 </select>
              </div>
            </div> 
		     ...
		     <div class="col-12 col-sm-4 mb-2">
              <div class="form-group">
                 ...
                 <input type="text" class="form-control check-emi" placeholder="Instalment" onkeypress="return isWholeNumberKey(event,this)" name="instalment" id="instalment" value="<?= $data['instalment'];?>" required>
              </div>
            </div>	
			...
			<div class="col-12 col-sm-4 mb-2">
              <div class="form-group">
                 ...
                 <input type="number" step="any" name="emi" id="emi" value="<?= $data['emi'];?>"  class="form-control" placeholder="EMI" readonly disabled> 
              </div>
            </div>   
			
            <div class="col-12 col-sm-4 mb-2">
              <label class="form-label">Applied Date<i class="required">*</i></label>
              <input type="text" class="form-control flatpickr-max" name="applied_date" value="<?= $data['applied_date'];?>" placeholder="YYYY-MM-DD" required>
            </div> 
			...
			<div class="col-12 col-sm-4 mb-1">
			  ...
			  <?php if($data['attachment']!=''){?>
			   <a href="<?= base_url().$data['attachment'];?>" class="text-primary" target="_blank">Previous File</a>
			  <?php }?>
			</div>
