      ...
      <div class="card-body">
        <div class="row">
          <div class="col-md-12 mt-10">
            <h5 class="mb-0"><b>Total Purchase Reports<span id="total_count"> (0)</span></b>
            </h5>
          </div>
        </div>
      </div>
...
<script type="text/javascript">
 $(document).ready(function($) {
    var dateRangeValue = '<?php echo (isset($_GET['date_range'])) ? $_GET['date_range'] : '' ?>';
    var isDateFiltered = dateRangeValue !== '';
    ...
    var dataTable = $('#report-datatable').DataTable({
        ...
        "ajax": {
            "url": "<?php echo base_url('inventory/get_purchase_reports'); ?>",
            "dataType": "json",
            "type": "POST",
            "data": function(data) {
                data.date_range = '<?php echo (isset($_GET['date_range'])) ? $_GET['date_range'] : '' ?>';
                data.supplier_id = '<?php echo (isset($_GET['supplier_id'])) ? $_GET['supplier_id'] : '' ?>';
            },
            "beforeSend": function() {
                $('.loader').show();
            },
