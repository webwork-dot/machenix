         ...
         <div class="card-body">
            <div class="row">
               <div class="col-md-12 mt-10">
                  <h5 class="mb-0"><b>Total TDS Data <span id="total_count"> (0)</span></b></h5>
               </div>
            </div>
         </div>
         <div class="card-datatable d-report mb-2"> 
		 <a href="<?php echo site_url('hr/tds/add'); ?>" class="dt-button add-new  add-btn btn btn-primary" tabindex="0" aria-controls="DataTables_Table_0" ><span><i data-feather='plus'></i> Add TDS</span></a>  
...
<script type="text/javascript"> 
  $(document).ready(function($) { 
        var dataTable = $('#repots-datatable').DataTable({ 
            ...
            "ajax":{
                "url": "<?php echo base_url('attendance/get_tds'); ?>",
                "dataType": "json",
                "type": "POST",
                "data": function(data){   
