  ...
  <div class="col-12">
    ...
    <div class="card">
      <div class="card-body py-1 my-0">
          <?php echo form_open('inventory/supplier/edit_post/'.$id, ['class' => 'add-ajax-ph-form','onsubmit' => 'return checkForm(this);']);?>   
           ...
           <div class="row">
            ...
            <div class="col-12 col-sm-4 mb-1">
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" class="form-control" placeholder="0.00" name="outstanding_rmb" value="<?php echo isset($data['outstanding_rmb']) ? number_format($data['outstanding_rmb'], 2, '.', '') : '0.00'; ?>">
                </div>
            </div>
            ...
            <div class="col-12 col-sm-4 mb-1">
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" class="form-control" placeholder="0.00" name="outstanding_inr" value="<?php echo isset($data['outstanding_inr']) ? number_format($data['outstanding_inr'], 2, '.', '') : '0.00'; ?>">
                </div>
            </div>
            ...
            <div class="col-12 col-sm-4 mb-1">
                <div class="form-group">
                    ...
                    <input type="number" step="0.01" class="form-control" placeholder="0.00" name="outstanding_usd" value="<?php echo isset($data['outstanding_usd']) ? number_format($data['outstanding_usd'], 2, '.', '') : '0.00'; ?>">
                </div>
            </div>
