...
<body class="invoice txtup">
      <div class="panel-body" id="page-wrap">
		...
		<table id="invoice_3" class="m-t-10 table" style="table-layout: fixed;border-top: 2px solid #808080;">
            <thead>
            <tr>
                <th class="p-l-r text-left border-r" style="width: 65%;" rowspan="1">
                    <p><b>Rajasthan Aushdhalaya Pvt. Ltd.</b></p>
                    <p><?= $data['warehouse_address'];?></p>
                    <p><b>GSTIN : </b> <?= $data['warehouse_gst_no'];?></p>
					<br/>
					 <p><b>Order No : </b> <?= $data['order_unique_id'];?> | <b>Invoice No : </b> <?= $data['invoice_no'];?></p>
                ...
                <th class="p-l-r border-b  border-r text-left"  style="width: 35%;" rowspan="2">
                  <center> <img src="<?= base_url().$data['qr_code'];?>" style="width:250px;margin:0 auto;"></center>
                </th>
            </tr>  
            
            <tr class="">
                <th class="p-l-r text-left border-t border-b border-r" style="width: 50%;">
                    <p><b> Doctor Name : </b> <?= $shipping['doctor_name'];?></p>  
		...
		<tr class="border-top">
    		<td colspan="9" class="left">
		       <p><b>IRN NO : </b><?= $data['irn'];?></p>
		       <p><b>ACK NO : </b><?= $data['ack_no'];?></p>
		       <p><b>ACK DATE : </b><?= $data['ack_date'];?></p>
    		</td>
