  ...
  <div class="col-12">
    ...
    <div class="card">
      <div class="card-body py-1 my-0">
          ...
          <?php echo form_open('attendance/paidleave/edit_post/'.$id, ['class' => 'add-ajax-redirect-image-form', 'enctype' => 'multipart/form-data', 'onsubmit' => 'return checkForm(this);' ]);?>
          <div class="row">
			...
			<div class="col-12 col-sm-4 mb-2">
              <div class="form-group">
                 <label class="form-label">Paid Leave<i class="required">*</i></label>
                 <select class="form-select" name="leaves" required>
					<option value="" <?php if($data['leaves']==''){ echo 'selected';}?>>Select</option>
					<?php for ($i = 0.5; $i <= 10; $i += 0.5) {?>
						<option value="<?= $i;?>" <?php if($data['leaves']==$i){ echo 'selected';}?>><?= $i;?></option>
					<?php } ?>
				</select>
              </div>
            </div>
			...
			<div class="col-12 col-sm-4 mb-2">
			<label class="form-label">Applied On Salary<i class="required">*</i></label>
