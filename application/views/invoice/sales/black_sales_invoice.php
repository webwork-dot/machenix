...
<body>
  <div style="background:#ffffff;margin:0 auto;width:100%;padding:0px;">
    ...
    <table style="width:100%;border-collapse:collapse;font-size:10px;">
      <thead>
        <tr>
          <td rowspan="2" style="border:1px solid;padding:4px;text-align:center;"><b>Sl No</b></td>
          <td rowspan="2" style="border:1px solid;padding:4px;text-align:center;"><b>Description of Goods</b></td>
          <td rowspan="2" style="border:1px solid;padding:4px;text-align:center;"><b>HSN/SAC</b></td>
          <td rowspan="2" style="border:1px solid;padding:4px;text-align:center;"><b>Quantity</b></td>
          <td colspan="2" style="border:1px solid;padding:4px;text-align:center;"><b>Rate</b></td>
          <td rowspan="2" style="border:1px solid;padding:4px;text-align:center;"><b>Per</b></td>
          <td rowspan="2" style="border:1px solid;padding:4px;text-align:center;"><b>Amount</b></td>
        </tr>
        <tr>
          <td style="border:1px solid;padding:4px;text-align:center;"><b>White</b></td>
          <td style="border:1px solid;padding:4px;text-align:center;"><b>Black</b></td>
        </tr>
      </thead>
      ...
      <tbody>
        <?php 
          ...
          foreach ($data['products'] as $product): 
            ...
            $white_rate = ($product['qtys'] > 0) ? ($product['white_amt'] / $product['qtys']) : 0;
            $black_rate = ($product['qtys'] > 0) ? ($product['black_amt'] / $product['qtys']) : 0;
        ?>
        <tr>
          ...
          <td style="border:1px solid;padding:4px;text-align:right;"><?= number_format($white_rate, 2); ?></td>
          <td style="border:1px solid;padding:4px;text-align:right;"><?= number_format($black_rate, 2); ?></td>
          <td style="border:1px solid;padding:4px;text-align:center;">Pc</td>
          <td style="border:1px solid;padding:4px;text-align:right;"><?= number_format($product['white_amt'] + $product['black_amt'], 2); ?></td>
        </tr>
        <?php endforeach; ?>
        ...
        <?php 
          ...
          foreach ($data['products'] as $product): 
            if ($product['gst_amount'] > 0):
              $sum_taxable += $product['white_amt'];
              $sum_gst += $product['gst_amount'];
        ?>
        <tr>
          <td style="border:1px solid;padding:4px;text-align:center;"><?= $product['hsn_code']; ?></td>
          <td style="border:1px solid;padding:4px;text-align:right;"><?= number_format($product['white_amt'], 2); ?></td>
          <?php if ($data['gst_type'] == 'IGST'): ?>
