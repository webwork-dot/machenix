                    ...
                    <tr class="batch-row batch-row-<?php echo $k; ?>" data-min-price="<?php echo $min_selling_price; ?>" data-min-billing-price="<?php echo $min_billing_price; ?>">
                      ...
                      <td style="min-width: 170px;">
                        <div class="d-flex flex-column gap-25">
                          <input type="text" class="form-control batch_remark" name="batch_remark[<?php echo $k; ?>][]" id="batch_remark_<?php echo $k; ?>_<?php echo $batch_index; ?>" placeholder="Remark" value="<?php echo htmlspecialchars($batch['remark'] ?? ''); ?>" readonly>
                      ...
                      <td style="min-width: 170px;">
                        <div class="d-flex flex-column gap-25">
                          <input type="text" class="form-control batch_bill_remark" name="batch_bill_remark[<?php echo $k; ?>][]" id="batch_bill_remark_<?php echo $k; ?>_<?php echo $batch_index; ?>" placeholder="Bill Remark" value="<?php echo htmlspecialchars($batch['bill_remark'] ?? ''); ?>" readonly>
