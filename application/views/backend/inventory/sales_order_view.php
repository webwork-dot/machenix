<style>
   ...
   #requirement_area .select2-container--default .select2-selection--single .select2-selection__rendered, {
	...
	.select2-container--default .select2-selection--single .select2-selection__rendered {
        line-height: 30px; /* Adjust the line-height to change the height */
		min-height: 30px;
		line-height: normal;
    }
          ...
          <div class="row">
            ...
            <div class="col-12 col-sm-12 mb-1 mt-1">
                <div class="form-group">
                    ...
                    <textarea class="form-control" placeholder="" rows="1" name="narration" id="narration" readonly><?php echo trim($data['narration']);?></textarea>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-12 mb-1">
                <div class="form-group">
                    <label>Remark</label>
                    <textarea class="form-control" placeholder="" rows="1" name="remark" id="remark" readonly><?php echo $data['remark'];?></textarea>
                </div>
            </div>
			
			<div class="col-12">
				<div id = "requirement_area"> 
					<?php $order_product = $this->common_model->selectByids(array("order_id"=> $id),'sales_order_product','id','ASC');
					$i= '1';
							...
							<div class="row">
								...
								<div class="col-md-2">
									<div class="form-group">
										...
										<input type="text" class="form-control" value="<?php echo $op->product_order_id;?>" readonly>
									</div>
								</div>
								<div class="col-md-2">
									<div class="form-group">
										<label>Customer Name<span class="required">*</span></label>
										<input type="text" class="form-control" value="<?php echo $op->customer_name;?>" readonly>
									</div>
								</div>
                                <div class="col-md-2">
									<div class="form-group">
										<label>Pincode<span class="required">*</span></label>
										<input type="text" class="form-control" value="<?php echo $op->pincode;?>" readonly>
									</div>
								</div>
                                <div class="col-md-2">
									<div class="form-group">
										<label>State<span class="required">*</span></label>
										<input type="text" class="form-control" value="<?php echo $op->state;?>" readonly>
									</div>
								</div>
								<div class="col-md-3">
									<input type="hidden" name="x_value[]" id="x_value_1" value="1">
									<div class="form-group">
										<label>SKU Code - Size<span class="required">*</span></label>
										<input type="text" class="form-control" value="<?php echo $op->item_code.' | '.$op->size_name;?>" readonly>
									</div>
								</div>
								...
								<div class="col-md-2">
									<div class="form-group">
										...
										<input type="text" class="form-control" value="<?php echo $op->total_amount;?>" readonly>
									</div>
								</div>
								<?php $order_pr_batch = $this->common_model->selectByids(array("order_id"=> $id,"order_product_id"=> $op->id,),'sales_order_product_batch','id','ASC');
								$j= 1;
								foreach($order_pr_batch as $batch){
								?>
									<div class="col-md-1 pl-0">
										<div class="form-group">
											<label>Qty <span class="required">*</span></label>
											<input type="text" class="form-control" value="<?php echo $batch->batch_qty;?>" readonly> 
										</div>
									</div>
									
								<?php } ?>
								<div class="col-md-2 m-stock-avl pl-0">
									<br>
                        ...
                        <table class="table table-striped table-bordered mn-table mt-1">
                                    <tbody>
                                        <tr>
                                          ...
                                          <td colspan="1">
                                            <p class="td-blank">
												<input type="text" class="form-control" name="basic_value" value="<?php echo $data['basic_value'];?>" readonly>
											</p>
										...
										<td colspan="4" class="text-right align-middle">
											 <b class="mb-0 text-capitalize">Basic Net Sales Value (Exclu. GST)</b>
											 <input type="text" class="form-control dis-input" value="<?php echo $data['gst_type'];?>" readonly>
										  </td>
										  
										  <td colspan="1">
											<p class="td-blank">
											<input type="text" class="form-control" name="gst_type" value="<?php echo $data['net_sales_value_1'];?>" readonly>
											</p>
										  </td>
										</tr>
										
										<tr class=" <?php echo ($data['gst_type'] == 'Central GST / State GST') ? '' : 'hidden';?>" id="cgst_gst">
										  <th colspan="4" class="text-right align-middle">
											 <b class="mb-0 text-capitalize">Add : IN: Central GST</b>
											 <input type="text" class="form-control dis-input" value="<?php echo $data['cgst_per'];?>" readonly>
										  </th>
										  <th colspan="1">
											 <p class="td-blank"><b><input type="number" step="any"  name="central_gst" id="central_gst"   value="<?php echo $data['central_gst'];?>" readonly  placeholder="Add : IN: Central GST" class="form-control" readonly></b></p>
										  </th>
										</tr>
										
										<tr class=" <?php echo ($data['gst_type'] == 'Central GST / State GST') ? 'IGST' : 'hidden';?>" id="sgst_gst">
										  <th colspan="4" class="text-right align-middle">
											 <b class="mb-0 text-capitalize">Add : IN: State GST</b>
											 <input type="text" class="form-control dis-input" value="<?php echo $data['sgst_per'];?>" readonly>
										  </th>
										  <th colspan="1">
											 <p class="td-blank"><b><input type="number" step="any"  name="state_gst" id="state_gst"   value="<?php echo $data['state_gst'];?>" readonly placeholder="Add : IN: State GST" class="form-control" readonly></b></p>
										  </th>
										</tr>
										...
										<tr class="hidden" id="igst_gst">
										  <th colspan="4" class="text-right align-middle">
											...
											<input type="text" class="form-control dis-input" value="<?php echo $data['igst_per'];?>" readonly>
										  </th>
										  <th colspan="1">
											 <p class="td-blank"><b><input type="number" step="any"  name="igst" id="igst"   value="<?php echo $data['igst'];?>" readonly  placeholder="Add : IN: IGST" class="form-control" readonly></b></p>
										  </th>
										</tr> 
                                        ...
                                        <tr>
                                          ...
                                          <td colspan="1">
                                            <p class="td-blank"><input type="number" step="any"  name="net_sales_value_2" id="net_sales_value_2" value="<?php echo $data['net_sales_value_2'];?>" readonly  placeholder="Basic Net Sales Value (Inc. GST)" class="form-control" readonly></p>
										...
										<tr>
                                          <td colspan="4" class="text-right">
											 ...
											 <input type="text" step="any" name="other_charges_name" id="other_charges_name" value="<?php echo $data['other_charges_name'];?>" readonly placeholder="Charge Name" class="form-control dis-input-1">
                                          </td>
                                          <td colspan="1">
                                             <p class="td-blank"><input type="number" step="any"  name="other_charges_amount" id="other_charges_amount" placeholder="Charge Amount" class="form-control" value="<?php echo $data['other_charges_amount'];?>" readonly onkeyup="recalculate()" ></p>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td colspan="4" class="text-right">
                                          ...
                                          <td colspan="1">
                                             <p class="td-blank"><input type="number" step="any"  name="round_of" id="round_of" placeholder="Round Of" class="form-control" value="<?php echo $data['round_of'];?>" readonly onkeyup="recalculate()" ></p>
                                          </td>
                                        </tr>
                                        <tr>
                                          <td colspan="4" class="text-right">
                                          ...
                                          <td colspan="1">
                                             <p class="td-blank"><input type="number" step="any"  name="grand_total" id="grand_total" placeholder="" class="form-control" value="<?php echo $data['grand_total'];?>" readonly></p>
                                          </td>
                                        </tr>
                                    </tbody>
                                </table>
...
<script>
    ...
    function appendRequirement() {
        ...
        if(customer_id==''){
            ...
            if($('#product_id_'+split_id[1]).find(":selected").val() == ''){
                ...
                $('#requirement_area').append('<div class="d-block mt-2 element-1 fx-border" id="product_'+nextindex+'" data-id="'+nextindex+'"><b class="jsr-no">'+nextindex+'</b><div class="flex-grow-1 px-0 ml-15"><div class="row"><div class="col-md-12"><div class="row"><div class="col-md-7"><input type="hidden" name="x_value[]" id="x_value_'+nextindex+'" value="'+nextindex+'"><div class="form-group"><label>Select SKU Code - Product Name<span class="required">*</span></label><select class="form-control select2 product_id" name="product_id[]" id="product_id_'+nextindex+'" data-toggle="select2" onchange="get_batch_by_product(this.value,'+extra_val+');" required><option value="">Select SKU Code - Product Name</option><?php foreach($products_list as $item){?><option value="<?php echo $item->id; ?>"><?php echo $item->item_code.' - '.$item->name; ?></option><?php } ?></select></div></div><div class="col-md-2 pl-0"><div class="form-group"><label>Total Amount <span class="required">*</span></label><input type="number" step="any" id="total_amount_'+nextindex+'" name="total_amount[]" value="" class="form-control" onkeyup="recalculate()"></div></div><div class="col-md-2 m-stock-avl pl-0"><br><label id="live_qty_'+nextindex+'">Total Available - 0 QTY</label></div><div class="col-md-1 pl-0"><div class="form-group"><label>&nbsp;</label><br/><button type="button" class="btn btn-danger btn-sm waves-effect waves-float waves-light" name="button" onclick="removeRequirement(this,'+nextindex+')"><i class="fa fa-times" aria-hidden="true"></i></button></div></div></div></div><div id="batch_tab_1"><div class="row newelement-1" id="batch_'+nextindex+'_1" data-id="'+nextindex+'_1"><div class="col-md-3"><div class="form-group"><label>Batch <span class="required">*</span></label><select class="form-control select2 batch_no_'+nextindex+'" name="batch_no_'+nextindex+'[]" id="batch_no_'+nextindex+'_1" data-toggle="select2" onchange="get_product_details(this.value,'+extra_val+');" required><option value="">Select Batch</option><?php foreach($products_list as $item){?><option value="<?php echo $item->name; ?>"><?php echo $item->name; ?></option><?php } ?></select></div></div><div class="col-md-1 pl-0"><div class="form-group"><label>Qty <span class="required">*</span></label><input type="number" step="any" id="quantity_'+nextindex+'_1" name="quantity_'+nextindex+'[]" placeholder="Qty" onkeyup="check_available_qty(this.value,'+nextindex+')" value="1" class="form-control quantity_'+nextindex+'" required=""></div></div><div class="col-md-2 pl-0"><div class="form-group"><label>Available Qty <span class="required">*</span></label><input type="number" step="any" id="available_'+nextindex+'_1" name="available_'+nextindex+'[]" placeholder="Available Qty" value="" class="form-control" required="" readonly></div></div><div class="col-md-1 pl-0"><label>&nbsp;</label><br/><button type="button" class="btn btn-danger btn-sm waves-effect waves-float waves-light" name="button" onclick="removeRequirement1(this,'+extra_val+')"><i class="fa fa-minus" aria-hidden="true"></i></button></div></div></div><div class="col-md-12 mt-1 mb-1 pl-0 m-auto"><button type="button" class="btn btn-relief-primary waves-effect" onclick="appendRequirement1('+nextindex+')"><i class="fa fa-plus" aria-hidden="true"></i> Add Batch</button></div></div></div></div></div>');
                    $(".loader").fadeOut("slow");
                    $(".select2").select2();
	...
	function appendRequirement1(id) {
		...
		if($('#batch_no_'+id+'_'+split_id[2]).val() == ''){
			...
			$('#batch_tab_'+id).append('<div class="row newelement-1" id="batch_'+id+'_'+ nextindex +'" data-id="'+id+'_'+ nextindex +'" ><div class="col-md-3 "><div class="form-group"><label>Batch <span class="required">*</span></label><select class="form-control select2 batch_no_'+ id +'"  name="batch_no_'+ id +'[]"  id="batch_no_'+id+'_'+ nextindex +'" data-toggle="select2" onchange="get_product_details(this.value,'+x_net+');"  required><option value="">Select Batch</option><?php foreach($products_list as $item){?><option value="<?php echo $item->name; ?>"><?php echo $item->name; ?>/option><?php } ?></select></div></div><div class="col-md-1 pl-0"><div class="form-group"><label>Qty <span class="required">*</span></label><input type="number" step="any" id="quantity_'+id+'_'+ nextindex +'" name="quantity_'+ id +'[]" placeholder="Qty" onkeyup="check_available_qty(this.value,'+ id +')" value="1" class="form-control quantity_'+ id +'" required=""></div></div><div class="col-md-2 pl-0"><div class="form-group"><label>Available Qty <span class="required">*</span></label><input type="number" step="any" id="available_'+id+'_'+ nextindex +'" name="available_'+ id +'[]" placeholder="Available Qty"  value="" class="form-control" required="" readonly></div></div><div class="col-md-1  pl-0"><label>&nbsp;</label><br/><button type="button" class="btn btn-danger btn-sm waves-effect waves-float waves-light" style="" name="button" onclick="removeRequirement1(this,'+id+'_'+ nextindex +')"> <i class="fa fa-minus" aria-hidden="true"></i> </button></div></div>');
			$(".loader").fadeOut("slow");
			$(".select2").select2();
	...
	function get_batch_by_product(b,nextindex) {
		...
		if(is_disabled == 0){
			...
			$.ajax({
				type: "POST",
				url:   "<?php echo base_url()?>inventory/get_batch_by_product",
				data: a,
				success: function(res) {
				   $('#batch_no_'+nextindex).children("option:not(:first)").remove();
				   $('#batch_no_'+nextindex).append(res);
				}
			});
			$.ajax({
				type: "POST",
