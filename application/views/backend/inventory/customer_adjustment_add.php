...
<div class="row">
  <div class="col-12">
    <div class="card adj-card mb-3">
      <form action="<?= base_url('inventory/customer-adjustment/add_post') ?>" method="post" id="adjustmentForm" novalidate>
        
        <!-- Header Bar with Title, Tabs, Date, Type & Add Row Button -->
        <div class="card-header d-flex flex-wrap justify-content-between align-items-center gap-2">
          <div class="d-flex align-items-center gap-3">
            <h5 class="mb-0 fw-bold text-dark fs-14">Add Customer Adjustment</h5>
            
            <ul class="nav adj-nav-pills" id="adjustmentTabs" role="tablist">
              <li class="nav-item" role="presentation">
                <button class="nav-link active" id="tab-to-customers-btn" data-bs-toggle="pill" data-bs-target="#tab-to-customers" type="button" role="tab" aria-controls="tab-to-customers" aria-selected="true">
            ...
            <input type="hidden" name="adjustment_mode" id="adjustment_mode" value="to_customers">
          </div>
        ...
        <div class="card-body p-3">
          ...
          <div class="tab-content" id="adjustmentTabsContent">
            ...
            <!-- Tab 1: To Customers -->
            <div class="tab-pane fade show active" id="tab-to-customers" role="tabpanel" aria-labelledby="tab-to-customers-btn">
