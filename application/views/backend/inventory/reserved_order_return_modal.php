...
<?php echo form_open('inventory/reserved_order/delete_reserved_order', ['class' => 'add-new-form','onsubmit' => 'return checkForm(this);']);?> 
...
<script>
    ...
    function get_product() {
        ...
        var a = {
          ...
          $.ajax({
          type: "POST",
          url:   "<?php echo base_url()?>inventory/get_reserved_order_product",
          data: a,
	...
	function get_check_rcv_multi_qty() {
        ...
        for (let i = 1; i < total_element ; i++) {
			...
			console.log('x_product_id :',product_id);
			if(rcv_quantity > quantity){
