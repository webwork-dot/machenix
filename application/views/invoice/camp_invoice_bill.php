		...
		<table id="invoice_3" class="m-t-10 table" style="table-layout: fixed;border-top: 2px solid #808080;">
            ...
            <tr class="">
                <th class="p-l-r text-left border-t border-b border-r" style="width: 50%;">
					...
					<?php } else{
					$asm=$this->common_model->getRowById('asm_users','phone,state_name',array('id'=>$data['bill_to_id']));?>	 

					<p><b> ASM Name : </b> <?= $data['bill_to'];?></p> 
					<p><b> Mobile No. : </b> <?= $asm['phone'];?></p>
                    <p><b> Billing Address : </b><?= $data['bill_address'];?></p>
                    <p><b>GSTIN : </b> URP &nbsp; &nbsp; &nbsp; &nbsp; 
					<b>State Code : </b> <?= $this->common_model->get_state_code($asm['state_name']);?></p>
