...
--
-- Table structure for table `customer_quotation_products`
--

CREATE TABLE `customer_quotation_products` (
  `id` int(11) NOT NULL,
...
--
-- Indexes for table `customer_quotation_products`
--
ALTER TABLE `customer_quotation_products`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `customer_quotation_products`
--
ALTER TABLE `customer_quotation_products`
